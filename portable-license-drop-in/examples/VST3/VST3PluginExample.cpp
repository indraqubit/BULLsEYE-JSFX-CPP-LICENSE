/*
  ==============================================================================
  Example: VST3 Plugin with License Drop-In Integration
  
  This example shows how to integrate the Portable License Drop-In Kit
  with a VST3 audio plugin using the JUCE framework.
  
  Key principles demonstrated:
  1. Initialize license engine once in constructor
  2. Thread-safe license checks in audio processing
...
class MyVST3Plugin  : public juce::AudioProcessor
{
private:
...
private:
    //==============================================================================
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (MyVST3Plugin)
};
...
{
public:
    MyPluginEditor (MyVST3Plugin& p, LicenseEngine::LicenseEngine& le)
